...
public class SceneGraph extends JPanel {
	...
	// (DELETE THIS EXAMPLE)
		...
		private TransformedObject  W1,W2,W3,W4,W5,W6; // wielokaty
	/**
	...
	private void createWorld() {
		...
		world.add(L3);
		W1 = new TransformedObject(wielakat);
		W1.setScale(0.2, 0.2).setTranslation(-0.889, -0.42);
		world.add(W1);
		W2 = new TransformedObject(wielakat);
		W2.setScale(0.2, 0.2).setTranslation(0.899, -1.189);
		world.add(W2);
		W3 = new TransformedObject(wielakat);
		W3.setScale(0.2, 0.2).setTranslation(-3, 1.825);
		world.add(W3);
		W4 = new TransformedObject(wielakat);
		W4.setScale(0.2, 0.2).setTranslation(-1.4, 1.18);
		world.add(W4);
		W5 = new TransformedObject(wielakat);
		W5.setScale(0.2, 0.2).setTranslation(0.83, 2.07);
		world.add(W5);
		W6 = new TransformedObject(wielakat);
		W6.setScale(0.2, 0.2).setTranslation(2.16, 1.52);
		world.add(W6);
	...
	public void updateFrame() {
		frameNumber++;
		W1.setRotation(frameNumber);
		W2.setRotation(frameNumber);
		W3.setRotation(frameNumber);
		W4.setRotation(frameNumber);
		W5.setRotation(frameNumber);
		W6.setRotation(frameNumber);
	...
	//wielokąt
	private static SceneGraphNode wielakat = new SceneGraphNode()
	{void doDraw(Graphics2D g){
		int n = 17;
		double t=0;
