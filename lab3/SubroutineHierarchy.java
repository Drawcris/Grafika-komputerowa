...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		wielakat(g2, 100, -1.02, -0.05);
		wielakat(g2, 100, 1.04, -0.98);
		wielakat(g2, 80, -1.379, 1.40);
		wielakat(g2, 80, -3.13, 2.23);
		wielakat(g2, 60, 0.9, 2.05);
		wielakat(g2, 60, 2.12, 1.45);
	...
	private void wielakat (Graphics2D g2,double r, double translate_x ,double translate_y) // polygon
	{
		AffineTransform saveTransform = g2.getTransform();
