...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        float[] oswietlenie1  = {0.4f, 0.4f, 0.4f, 1};
        float[] oswietlenie2  = {0, 0, 0.8f, 1};
        float[] oswietlenie3  = {0.3f, 0.15f, 0.15f, 1};
        gl2.glLightfv (gl2.GL_LIGHT1, gl2.GL_DIFFUSE, oswietlenie1,0);
        gl2.glLightfv (gl2.GL_LIGHT1, gl2.GL_SPECULAR, oswietlenie2,0);
        gl2.glLightfv (gl2.GL_LIGHT1, gl2.GL_AMBIENT, oswietlenie3,0);
